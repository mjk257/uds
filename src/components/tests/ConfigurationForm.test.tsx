...
describe("Testing ConfigurationList component", () => {
    ...
    test("renders ConfigurationList header and configuration buttons", () => {
        ...
        const highWalkabilityTransabilityRadioGroup = screen.getByText("High Walkability/Transability?");
        expect(highWalkabilityTransabilityRadioGroup).toBeInTheDocument();
        const highQualityOfEducationRadioGroup = screen.getByText("High Quality of Education?");
        ...
        const preferredOccupationSelect = screen.getAllByText("Preferred Occupation");
